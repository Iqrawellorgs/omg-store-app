              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text(
                      PriceConverter.convertPrice(suggestion.price),
                      style: senRegular.copyWith(
                        color: Theme.of(context).textTheme.bodyLarge!.color,
          ...
          if (restaurant != null) {
            for (var cartModel in posController.cartList) {
              ...
              availableList.add(DateConverter.isAvailable(
                  cartModel.product!.availableTimeStarts, cartModel.product!.availableTimeEnds));
              ...
              discount = discount! +
                  ((cartModel.price! -
                          PriceConverter.convertWithDiscount(cartModel.price, dis, disType)!) *
                      cartModel.quantity!);
            }
                            ...
                            child: SizedBox(
                              ...
                              child:
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  Text('item_price'.tr, style: senRegular),
                                  Text(
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  Text('subtotal'.tr, style: senMedium),
                                  Text(
                                ...
                                const SizedBox(height: Dimensions.paddingSizeSmall),
                                Row(children: [
                                  Expanded(child: Text('discount'.tr, style: senRegular)),
                                  SizedBox(
                                    width: 70,
                                    child: MyTextField(
                                      title: false,
