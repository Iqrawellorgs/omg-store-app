  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<AuthController>(builder: (authController) {
        ...
        return authController.packageModel != null
            ? Column(children: [
                Expanded(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      authController.renewStatus == 'packages'
                          ? SizedBox(
                              height: 600,
                              child: (authController.packageModel!.packages!.isNotEmpty &&
                                  ...
                                  ? Swiper(
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        Packages package =
                                            authController.packageModel!.packages![index];
                                        ...
                                        return GetBuilder<AuthController>(
                                          ...
                                          return Stack(clipBehavior: Clip.none, children: [
                                            ...
                                            authController.activeSubscriptionIndex == index
                                                ? Positioned(
                                                    top: 5,
                                                    right: -10,
                                                    child: Container(
                          ...
                          : Padding(
                              ...
                              child: Column(children: [
                                refundPaymentCart(
                                  ...
                                  subTitle:
                                      '${PriceConverter.convertPrice(authController.profileModel!.balance)} ${'payable_amount_in_your_wallet'.tr}',
                                  index: 0,
                                  onTap: () {
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(
                      horizontal: Dimensions.fontSizeLarge, vertical: Dimensions.paddingSizeSmall),
                  child: (authController.packageModel!.packages!.isNotEmpty &&
                          authController.packageModel!.packages!.isNotEmpty)
                      ? !authController.isLoading
                          ? CustomButton(
                              buttonText:
                                  (authController.isActivePackage! && activePackageIndex != -1)
                                      ? 'renew'.tr
                                      : 'shift_this_plan'.tr,
                              onPressed: () {
                                if (authController.renewStatus == 'packages') {
                                  ...
                                  authController.renewBusinessPlan(
                                      authController.profileModel!.restaurants![0].id.toString());
                                }
                              },
                            )
          ...
          InkWell(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: authController.refundPaymentIndex == index
                    ? Border.all(color: Theme.of(context).primaryColor, width: 1)
                    : null,
                boxShadow: authController.refundPaymentIndex != index
                    ? [BoxShadow(color: Colors.grey[300]!, blurRadius: 10)]
                    : null,
                color: authController.refundPaymentIndex == index
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(
                  subTitle,
                  style: senRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color),
                ),
              ]),
            ),
          ),
