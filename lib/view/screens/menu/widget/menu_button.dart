...
class MenuButton extends StatelessWidget {
  ...
  final bool isLogout;
  const MenuButton({Key? key, required this.menu, required this.isProfile, required this.isLogout})
      : super(key: key);
      ...
      child: Column(children: [
        Container(
          ...
          child: isProfile
              ...
              : Image.asset(menu.icon, width: size, height: size, color: Colors.white),
        ),
