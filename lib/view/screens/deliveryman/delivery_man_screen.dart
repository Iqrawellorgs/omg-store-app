            ...
            ? dmController.deliveryManList!.isNotEmpty
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () =>
                            Get.toNamed(RouteHelper.getDeliveryManDetailsRoute(deliveryMan)),
                        child: Column(children: [
                          Row(children: [
                            ...
                            IconButton(
                              onPressed: () =>
                                  Get.toNamed(RouteHelper.getAddDeliveryManRoute(deliveryMan)),
                            ...
                            IconButton(
                              onPressed: () {
                                Get.dialog(ConfirmationDialog(
                                  ...
                                  onYesPressed: () => Get.find<DeliveryManController>()
                          ...
                          Padding(
                            ...
                            child: Divider(
                              color: index == dmController.deliveryManList!.length - 1
                                  ? Colors.transparent
