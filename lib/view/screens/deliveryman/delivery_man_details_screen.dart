              ...
              Row(children: [
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                        color: deliveryMan.active == 1 ? Colors.green : Colors.red, width: 2),
                ...
                Expanded(
                  ...
                  Row(children: [
                    ...
                    Text(deliveryMan.avgRating!.toStringAsFixed(1), style: senRegular),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                    Text(
                          ...
                          ? dmController.dmReviewList!.isNotEmpty
                              ...
                              : Padding(
                                  ...
                                  child: Center(
                                    ...
                                    'no_review_found'.tr,
                                    style:
                                        senRegular.copyWith(color: Theme.of(context).disabledColor),
                                  )),
                                )
                          : const Padding(
