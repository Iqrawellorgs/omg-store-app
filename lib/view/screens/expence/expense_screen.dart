        ...
        return Column(children: [
          Padding(
            padding: const EdgeInsets.symmetric(
                horizontal: Dimensions.radiusDefault, vertical: Dimensions.radiusDefault),
            child: Row(children: [
              Expanded(
                child: Container(
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Text('from'.tr, style: senMedium.copyWith(color: Theme.of(context).disabledColor)),
            ...
            Container(
              ...
              child:
                  Text(DateConverter.convertDateToDate(expenseController.from!), style: senMedium),
            ),
            const SizedBox(width: 5),
            Text('to'.tr, style: senMedium.copyWith(color: Theme.of(context).disabledColor)),
            const SizedBox(width: 5),
            Container(
              padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
              decoration: BoxDecoration(
              ...
              child: Text(DateConverter.convertDateToDate(expenseController.to!), style: senMedium),
            ),
          ]),
          Expanded(
            child: expenseController.expenses != null
                ? expenseController.expenses!.isNotEmpty
                    ...
                    : Center(child: Text('no_expense_found'.tr, style: senMedium))
