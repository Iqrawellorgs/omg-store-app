            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () =>
                        onSelected!(Get.find<RestaurantController>().productTypeList[index]),
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          left: Radius.circular(
                            ltr
                                ? index == 0
                                    ...
                                    : 0
                                : index ==
                                        Get.find<RestaurantController>().productTypeList.length - 1
                                    ? Dimensions.radiusSmall
                                    : 0,
                          ),
                        ...
                        color: Get.find<RestaurantController>().productTypeList[index] == type
