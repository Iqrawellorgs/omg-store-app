      ...
      child: GetBuilder<BankController>(builder: (bankController) {
        return SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Text('withdraw'.tr, style: senMedium),
            ...
            ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Column(children: [
                    ...
                    SizedBox(
                        height: index != bankController.methodFields.length - 1
                            ? Dimensions.paddingSizeLarge
                            : 0),
                  ]);
                }),

            // Text('enter_amount'.tr, style: robotoBold.copyWith(color: Theme.of(context).disabledColor)),
