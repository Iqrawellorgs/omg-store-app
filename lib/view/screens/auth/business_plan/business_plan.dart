            ...
            child: Center(
              child: Container(
                ...
                padding: context.width > 700
                    ...
                    : null,
                child: authController.businessPlanStatus == 'complete'
                    ? const SuccessWidget()
                    : Column(children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(children: [
                                          Get.find<SplashController>()
                                                  ...
                                                  0
                                              ? Expanded(
                                                  child: baseCardWidget(authController, context,
                                                      title: 'commission_base'.tr,
                                                      index: 0,
                                                      onTap: () => authController.setBusiness(0)),
                                                )
                                              : const SizedBox(),
                                          ...
                                          Get.find<SplashController>()
                                              ...
                                              ? Expanded(
                                                  child: baseCardWidget(authController, context,
                                                      ...
                                                      index: 1,
                                                      onTap: () => authController.setBusiness(1)),
                                                )
                                              : const SizedBox(),
                                        ]),
                                      ),
                                      ...
                                      authController.businessIndex == 0
                                          ...
                                          : Column(children: [
                                              ...
                                              authController.packageModel != null
                                                  ? SizedBox(
                                                      height: 600,
                                                      child: (authController.packageModel!.packages!
                                                                  .isNotEmpty &&
                                  ...
                                  : Padding(
                                      ...
                                      child: Column(children: [
                                        ...
                                        paymentCart(
                                            ...
                                            index: 1,
                                            onTap: () => authController.setPaymentIndex(1)),
                                      ]),
                                    ),
                            ]),
                          ),
                        ...
                        Padding(
                          ...
                          child: Row(children: [
                            (authController.businessPlanStatus == 'payment')
                                      ...
                                      onTap: () {
                                        if (authController.businessPlanStatus != 'payment') {
                                          authController.showBackPressedDialogue(
                                              'your_business_plan_not_setup_yet'.tr);
                                        } else {
                                ...
                                : const SizedBox(),
                            SizedBox(
                                width: (authController.businessPlanStatus == 'payment')
                            ...
                            authController.businessIndex == 0 ||
                                ...
                                ? Expanded(
                                    ...
                                    buttonText: 'next'.tr,
                                    onPressed: () =>
                                        authController.submitBusinessPlan(widget.restaurantId),
                                  ))
                                : const SizedBox(),
                          ]),
                        )
        ...
        Container(
          decoration: BoxDecoration(
              ...
              boxShadow: authController.businessIndex == index
                  ...
                  : [
                      BoxShadow(
                          color: Colors.grey[200]!, offset: const Offset(5, 5), blurRadius: 10)
                    ]),
          padding: const EdgeInsets.symmetric(
