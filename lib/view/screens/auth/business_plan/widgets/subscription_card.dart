  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
      ...
      Text(
        ...
        style: senBold.copyWith(fontSize: 35, color: color),
      ),
...
class CardPaint extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Paint paint = Paint()
      ..shader = ui.Gradient.linear(Offset(0, size.height),
          Offset(size.width * 0.4, size.height * 0.6), [Colors.white10, Colors.white12])
    ...
    Path path1 = Path()
      ...
      ..quadraticBezierTo(
          size.width * 0.25, size.height * 0.5, size.width * 0.5, size.height * 0.68)
      ..quadraticBezierTo(
          size.width * 0.65, size.height * 0.75, size.width * 0.7, size.height * 0.68)
