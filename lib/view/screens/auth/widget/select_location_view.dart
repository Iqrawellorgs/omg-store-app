...
class _SelectLocationViewState extends State<SelectLocationView> {
  ...
  Widget mapView(AuthController authController) {
    return authController.zoneList!.isNotEmpty
        ? Container(
            height:
                widget.fromView ? MediaQuery.of(context).size.height * 0.4 : (context.height * 0.7),
                        ...
                        child: InkWell(
                          onTap: () async {
                            var p = await Get.dialog(LocationSearchDialog(
                                mapController:
                                    widget.fromView ? _mapController : _screenMapController));
                            Position? position = p;
                            if (position != null) {
                              _cameraPosition = CameraPosition(
                          ...
                          child: Container(
                            ...
                            child: Text('search'.tr,
                                style: senRegular.copyWith(color: Theme.of(context).hintColor)),
                          ),
                        ),
                      )
                    : const SizedBox(),
                    ...
                    ? Positioned(
                        ...
                        child: InkWell(
                          onTap: () {
                            Get.to(
                              Scaffold(
                                  appBar: CustomAppBar(title: 'Select your location'.tr),
