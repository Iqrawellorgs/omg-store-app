      ...
      child: GetBuilder<OrderController>(builder: (orderController) {
        return SizedBox(
          ...
          child: Column(children: [
                              ...
                              child: ListTile(
                                onTap: () {
                                  orderController.setOrderCancelReason(
                                      orderController.orderCancelReasons![index].reason);
                                },
                                title: Row(
                                  children: [
                                    Icon(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: Dimensions.fontSizeDefault, vertical: Dimensions.paddingSizeSmall),
                          ...
                          if (orderController.cancelReason != '' &&
                            ...
                            orderController
                                .updateOrderStatus(orderId, 'canceled',
                                    back: true, reason: orderController.cancelReason)
                                .then((success) {
                              if (success) {
