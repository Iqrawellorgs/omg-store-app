...
class OrderDetailsScreen extends StatefulWidget {
  ...
  const OrderDetailsScreen({Key? key, required this.orderModel, required this.isRunningOrder})
      : super(key: key);
      ...
      bool showSlider = controllerOrderModer != null
          ? (controllerOrderModer.orderStatus == 'pending' &&
              ...
              (controllerOrderModer.orderStatus == 'handover' &&
                  (selfDelivery || controllerOrderModer.orderType == 'take_away'))
          : false;
      bool showBottomView = controllerOrderModer != null
          ? showSlider || controllerOrderModer.orderStatus == 'picked_up' || widget.isRunningOrder
          : false;
            ...
            ? Column(children: [
                Expanded(
                  ...
                  child: Center(
                    ...
                    DateConverter.isBeforeTime(controllerOrderModer.scheduleAt)
                        ? (controllerOrderModer.orderStatus != 'delivered' &&
                                controllerOrderModer.orderStatus != 'failed' &&
                                controllerOrderModer.orderStatus != 'canceled' &&
                                controllerOrderModer.orderStatus != 'refunded' &&
                                controllerOrderModer.orderStatus != 'refund_request_canceled')
                            ? Column(children: [
                                ClipRRect(
                                  ...
                                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                                    Text(
                                      DateConverter.differenceInMinute(
                                                  ...
                                                  controllerOrderModer.createdAt,
                                                  controllerOrderModer.processingTime,
                                      ...
                                      style:
                                          senBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge),
                                    ),
                    ...
                    order.scheduled == 1
                        ? Row(children: [
                            Text('${'scheduled_at'.tr}:', style: senRegular),
                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    ...
                    subscription
                        ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                            Row(children: [
                              Text('${'subscription_date'.tr}:', style: senRegular),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                              Text(
                            ...
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                            Row(children: [
                              Text('${'subscription_type'.tr}:', style: senRegular),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                              Text(orderController.subscriptionModel!.type!.tr, style: senMedium),
                            ]),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                            const Divider(height: Dimensions.paddingSizeLarge),
                          ])
                    ...
                    order.unavailableItemNote != null
                        ? Row(children: [
                            Text('${'if_item_is_not_available'.tr}: ', style: senMedium),
                            Text(
                    ...
                    order.deliveryInstruction != null
                        ? Row(children: [
                            Text('${'delivery_instruction'.tr}: ', style: senMedium),
                            Text(
                    ...
                    SizedBox(
                        height:
                            order.deliveryInstruction != null ? Dimensions.paddingSizeSmall : 0),
                    ...
                    (order.orderNote != null && order.orderNote!.isNotEmpty)
                        ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text('additional_note'.tr, style: senRegular),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            Container(
                              width: 1170,
                              padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                      ...
                      child: Row(children: [
                        ...
                        Expanded(
                            child: order.deliveryAddress != null
                                ...
                                : Text('walking_customer'.tr, style: senMedium)),
                        ...
                        (controllerOrderModer.orderStatus != 'delivered' &&
                            ...
                            ? TextButton.icon(
                                onPressed: () async {
                                  if (Get.find<AuthController>().profileModel!.subscription !=
                                          null &&
                                      Get.find<AuthController>().profileModel!.subscription!.chat ==
                                          0 &&
                                ...
                                Expanded(
                                    child: Column(
                                      ...
                                      Text(
                                        ...
                                        overflow: TextOverflow.ellipsis,
                                        style:
                                            senRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                      ),
                                      Text(
                                        ...
                                        onPressed: () async {
                                          if (Get.find<AuthController>()
                                              ...
                                              Get.find<AuthController>()
                                                  ...
                                                  'subscription') {
                                            showCustomSnackBar(
                                                'you_have_no_available_subscription'.tr);
                                          } else {
                                            _timer.cancel();
                                            await Get.toNamed(RouteHelper.getChatRoute(
                                              notificationBody: NotificationBody(
                                              ...
                                              user: User(
                                                id: orderController.orderModel!.deliveryMan!.id,
                                                fName:
                                                    orderController.orderModel!.deliveryMan!.fName,
                                                lName:
                                                    orderController.orderModel!.deliveryMan!.lName,
                                                image:
                                                    orderController.orderModel!.deliveryMan!.image,
                                              ),
                                            ));
                                            _startApiCalling();
                                          }
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      Text(PriceConverter.convertPrice(itemsPrice),
                          style: senRegular, textDirection: TextDirection.ltr),
                    ]),
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      Text(PriceConverter.convertPrice(subTotal),
                          style: senMedium, textDirection: TextDirection.ltr),
                    ]),
                    const SizedBox(height: 10),
                    ...
                    couponDiscount > 0
                        ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('coupon_discount'.tr, style: senRegular),
                            Text(
                  ...
                  child: showBottomView
                      ? (controllerOrderModer.orderStatus == 'picked_up')
                          ? Container(
                              ...
                              child: Text('food_is_on_the_way'.tr, style: senMedium),
                            )
                          : showSlider
                              ? (controllerOrderModer.orderStatus == 'pending' &&
                                      (controllerOrderModer.orderType == 'take_away' ||
                                            ...
                                            Get.dialog(
                                                ConfirmationDialog(
                                                  ...
                                                  onYesPressed: () {
                                                    orderController
                                                        .updateOrderStatus(
                                                            controllerOrderModer.id, 'confirmed',
                                                            back: true)
                                                        .then((success) {
                                                      if (success) {
                                                        Get.find<AuthController>().getProfile();
                                  ...
                                  : SliderButton(
                                      action: () {
                                        if (controllerOrderModer.orderStatus == 'pending' &&
                                            (controllerOrderModer.orderType == 'take_away' ||
                                                restConfModel ||
                                                selfDelivery)) {
                                          Get.dialog(
                                              ConfirmationDialog(
                                                ...
                                                onNoPressed: () {
                                                  if (cancelPermission!) {
                                                    orderController
                                                        .updateOrderStatus(
                                                            controllerOrderModer.id, 'canceled',
                                                            back: true)
                                                        .then((success) {
                                                      if (success) {
                                                        Get.find<AuthController>().getProfile();
                                              ...
                                              barrierDismissible: false);
                                        } else if (controllerOrderModer.orderStatus ==
                                            'processing') {
                                          Get.find<OrderController>()
                                              .updateOrderStatus(
                                                  controllerOrderModer.id, 'handover')
                                              .then((success) {
                                            if (success) {
                                              Get.find<AuthController>().getProfile();
                                          ...
                                          Get.dialog(InputDialog(
                                            ...
                                            onPressed: (String? time) {
                                              if (double.tryParse(time ?? '') == null) {
                                                showCustomSnackBar('Please enter valid time');
                                                return;
                                              }
                                              Get.back();
                                              Get.find<OrderController>()
                                                  .updateOrderStatus(
                                                      controllerOrderModer.id, 'processing',
                                                      processingTime:
                                          ...
                                          if (Get.find<SplashController>()
                                              ...
                                              controllerOrderModer.paymentMethod ==
                                                  'cash_on_delivery') {
                                            Get.bottomSheet(
                                                VerifyDeliverySheet(
                                                  orderID: controllerOrderModer.id,
                                                  verify: Get.find<SplashController>()
                                                      .configModel!
                                                      .orderDeliveryVerification,
                                                  orderAmount: controllerOrderModer.orderAmount,
                                                  cod: controllerOrderModer.paymentMethod ==
                                                      'cash_on_delivery',
                                                ),
                                            ...
                                            Get.find<OrderController>()
                                                .updateOrderStatus(
                                                    controllerOrderModer.id, 'delivered')
                                                .then((success) {
                                              if (success) {
                                                Get.find<AuthController>().getProfile();
                                                Get.find<OrderController>().getCurrentOrders();
